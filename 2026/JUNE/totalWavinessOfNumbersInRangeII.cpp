...
// Time Complexity: O(16*2*2*10*3*16) which is approximately O(1) due to the fixed size of the dp array.
// Space Complexity: O(16*2*2*10*3*16) which is approximately O(1) due to the fixed size of the dp array.