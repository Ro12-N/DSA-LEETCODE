...
// TC : O(N * L + M * L) where N is the number of strings in s, M is the number of queries in q and L is the average length of the strings.
// SC : O(N * L) for the trie data structure.