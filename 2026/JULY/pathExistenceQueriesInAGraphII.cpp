...
// Time Complexity: O(n log n + q log n) where n is the length of the nums array and q is the number of queries
// Space Complexity: O(n log n) for storing the sparse table and other auxiliary data structures