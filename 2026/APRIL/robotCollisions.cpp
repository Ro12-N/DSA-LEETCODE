...
// TC: O(n log n) due to sorting the robots by their positions and then sorting the survivors by their original indices.
// SC: O(n) for the stack and the result vector.